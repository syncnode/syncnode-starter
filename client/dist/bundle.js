...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(3), __webpack_require__(0)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, syncnode_common_1, syncnode_client_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var TodoItem = (function (_super) {
        ...
        function TodoItem(options) {
            if (options === void 0) { options = {}; }
            var _this = _super.call(this, syncnode_client_1.SyncUtils.mergeMap(options, { tag: 'li' })) || this;
            _this.text = _this.add('div', { "innerHTML": "", "className": " div_text_style" });
            _this.addBtn = _this.add('button', { "innerHTML": "X", "className": "" });
            _this.el.className += ' ';
            _this.text.addEventListener('click', function () { _this.data.set('complete', !_this.data.complete); });
            _this.addBinding('text', 'innerHTML', 'data.text');
            _this.addBtn.addEventListener('click', function () { _this.data.parent.remove(_this.data.key); });
            return _this;
        }
    ...
    syncnode_client_1.SyncView.addGlobalStyle('.div_text_style', " display: inline-block; width: 15em; ");
    var MainView = (function (_super) {
        __extends(MainView, _super);
        function MainView(options) {
            if (options === void 0) { options = {}; }
            var _this = _super.call(this, syncnode_client_1.SyncUtils.mergeMap(options, {})) || this;
            _this.title = _this.add('h1', { "innerHTML": "Todo List", "className": "" });
            _this.newTodo = _this.add('input', { "innerHTML": "", "className": "" });
            _this.addBtn = _this.add('button', { "innerHTML": "Add Todo", "className": "" });
            _this.list = _this.addView(new syncnode_client_1.SyncList({ item: TodoItem, tag: 'ul' }), ' SyncList_list_style');
            _this.el.className += ' ';
            _this.el.className += ' MainView_style';
            _this.addBtn.addEventListener('click', function () {
                _this.data.todoItems.setItem({ text: _this.newTodo.value, complete: false });
                _this.newTodo.value = '';
            });
            _this.addBinding('list', 'update', 'data.todoItems');
            return _this;
        }
        return MainView;
    }(syncnode_client_1.SyncView));
    exports.MainView = MainView;
    syncnode_client_1.SyncView.addGlobalStyle('.SyncList_list_style', " margin-top: 1em ");
    syncnode_client_1.SyncView.addGlobalStyle('.MainView_style', " padding: 1em ");
}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
